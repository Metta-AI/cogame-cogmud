...
switch(
  "passL",
  (&"""
  -o {distDir / "cogmud_replay.js"}
  -O2
  -s ALLOW_MEMORY_GROWTH
  -s ABORTING_MALLOC=1
  -s ENVIRONMENT=web
  -s MODULARIZE=1
  -s EXPORT_NAME=CogmudReplayModule
  -s EXPORTED_RUNTIME_METHODS=HEAPU8
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_cm_load_replay,_cm_payload_ptr,_cm_payload_len,_cm_error_ptr,_cm_error_len
  """).replace("\n", " ")
)
